...
exports.SABError = void 0;
/**
 * Base exception class for SAB SDK errors.
 */
class SABError extends Error {
    constructor(message, errorCode, httpStatus, cause) {
        super(message);
        this.name = 'SABError';
    ...
    static authorization(message, cause) {
    ...
    static rateLimit(message, cause) {
        return new SABError(message, 'RATE_LIMIT_ERROR', 429, cause);
    }
    static server(message, httpStatus = 500, cause) {
